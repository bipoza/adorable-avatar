...
AdorableAvatar.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: AdorableAvatar, selectors: [["adorable-avatar"]], inputs: { color: "color", initials: "initials", name: "name", rounded: "rounded", size: "size", src: "src" }, ngContentSelectors: _c0, decls: 1, vars: 0, template: function AdorableAvatar_Template(rf, ctx) { if (rf & 1) {
